        ...
        <div class="container">
            <div class="row justify-content-between gy-5">
                <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
                    <h2 data-aos="fade-up">Mommy Toko Bahan Kue</h2>
                    <p data-aos="fade-up" data-aos-delay="100">Nikmati berbagai bahan kue berkualitas dari Mommy Toko Bahan Kue. Kami menyediakan pilihan terbaik untuk membuat kue favorit Anda.</p>
                    <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                        <a href="#contact-us" class="btn-book-a-table">Hubungi Kami</a>
    ...
    <main id="main">
        ...
        <section id="menu" class="menu">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>Our Menu</h2>
                    <p>Check Our <span>Mommy Menu</span></p>
                </div>
